...
public class JMenuTest1 extends JFrame{
	...
	public JMenuTest1() {
		...
		load.addActionListener(new MenuActionListenr());
		screenMenu.add(load);
		
		JMenuItem hide = new JMenuItem("Hide");
		hide.addActionListener(new MenuActionListenr());
		screenMenu.add(hide);
		
		JMenuItem reshow = new JMenuItem("Reshow");
		reshow.addActionListener(new MenuActionListenr());
		...
		exit.addActionListener(new MenuActionListenr());
		screenMenu.add(exit);
	...
	private class MenuActionListenr implements ActionListener{
